                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src='<spring:url value="resources/img/1.jpg"></spring:url>' alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src='<spring:url value="resources/img/2.jpg"></spring:url>' alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src='<spring:url value="resources/img/3.jpg"></spring:url>' alt="">
                                </div>
                            </div>
